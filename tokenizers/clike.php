...
class ClikeLexer extends DefaultLexer
{
	...
	protected $state_table = array(
		...
		CLIKE_COMM_STAR  => array('\/' => CLIKE_COMM_END,   '.'  => CLIKE_BCOMMENT),
		CLIKE_BCOMMENT   => array('\*' => CLIKE_COMM_STAR),
		CLIKE_COMM_END   => array(CLIKE_NORMAL),
		CLIKE_ESCAPE_S   => array('\'' => CLIKE_STRLIT_S, CLIKE_ESC_INV_S),
		CLIKE_ESCAPE_D   => array('["nrt\\\]' => CLIKE_STRLIT_D, CLIKE_ESC_INV_D),
		CLIKE_ESC_INV_D => array(CLIKE_STRLIT_D),
		CLIKE_ESC_INV_S => array(CLIKE_STRLIT_S),
	);
