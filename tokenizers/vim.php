...
class VimLexer extends DefaultLexer
{
	...
	protected $state_table = array(
		VIM_NORMAL     => array(
			'\'' => VIM_STRLIT_S, '"' => VIM_STRLIT_D, '[a-zA-Z]' => VIM_STRING,
		...
		VIM_OPERATOR   => array(
			'\'' => VIM_STRLIT_S, '"' => VIM_STRLIT_D, '[\d\.]' => VIM_NUMBER, VIM_NORMAL,
		),
		VIM_NUMBER     => array('[\-\+\^\>\<\*=\:\|\?\!]' => VIM_OPERATOR, '[^\d\.]' => VIM_NORMAL),
		VIM_COMM       => array('"' => VIM_END_QUOTE, "[\r\n]" => VIM_NORMAL),
