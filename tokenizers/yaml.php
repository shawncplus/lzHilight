...
class YamlLexer extends DefaultLexer
{
    ...
    protected $state_table = [
        YML_WHITESPACE => ['#' => YML_COMMENT, '-' => '&branchHeader', '\s' => YML_WHITESPACE, YML_KEY],
        YML_COMMENT => ["[\n\r]" => YML_WHITESPACE],
        YML_KEY => [
        ...
        YML_STRING_S => ['\'' => YML_END_QUOTE],
        YML_STRING_D => ['"' => YML_END_QUOTE],
        YML_VAL_I => ["[ \t]" => YML_I_WHITESPACE, "[\n\r]" => YML_WHITESPACE, '[\[\]:]' => YML_VALOP],
        YML_I_WHITESPACE => [
            "[\n\r]" => YML_WHITESPACE, '\'' => YML_STRING_S, '"' => YML_STRING_D, '#' => YML_COMMENT,
            '[\[\]:]' => YML_VALOP, "[\|>\+\-]" => YML_OPERATOR, '\d' => YML_VAL_I, "[^ \t]" => YML_VAL_S,
        ],
        YML_VAL_S => ['#' => YML_COMMENT, "[ \t]" => YML_I_WHITESPACE, "[\n\r]" => YML_WHITESPACE],
        YML_END_QUOTE => ["[ \t]" => YML_I_WHITESPACE, '[\[\]:]' => YML_VALOP, "[\n\r]" => YML_WHITESPACE, YML_KEY],
        YML_OPERATOR => ["[\|>\+\-]" => YML_OPERATOR, '[\[\]:]' => YML_VALOP, "[\n\r]" => YML_WHITESPACE, "[^ \t]" => YML_VAL_S, YML_KEY],
