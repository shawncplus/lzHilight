...
class CssLexer extends DefaultLexer
{
    ...
    protected $state_table = [
        CSS_WHITESPACE => ['[\'"]' => CSS_ERROR, '\/' => CSS_COMMENT, '\w' => CSS_IDENTIFIER, '#' => CSS_ID, '\.' => CSS_CLASS, '\{' => CSS_OPEN_BRACE, '\}' => CSS_CLOSE_BRACE, '[\>\+,\*]' => CSS_OPERATOR],
        CSS_IDENTIFIER => ['\.' => CSS_CLASS,  '#' => CSS_ID,      '\s' => CSS_WHITESPACE, '\{' => CSS_OPEN_BRACE, '\}' => CSS_CLOSE_BRACE, ':' => CSS_PSEUDO_CLASS, '[\>\+,\*]' => CSS_OPERATOR],
        CSS_CLASS => ['\w' => CSS_IDENTIFIER,  '\W' => CSS_ERROR],
        CSS_ID => [CSS_CLASS],
        CSS_PSEUDO_CLASS => ['\s' => CSS_WHITESPACE, '\{' => CSS_OPEN_BRACE],
        CSS_PROPERTY => [':' => CSS_MEASURE,    '[^\w-_]' => CSS_ERROR],
        CSS_MEASURE => [';' => CSS_BLOCK,      '\'' => CSS_STRING_S, '"' => CSS_STRING_D, '\}' => CSS_CLOSE_BRACE],
        CSS_STRING_S => ['\'' => CSS_MEASURE],
        CSS_STRING_D => ['"' => CSS_MEASURE],
        CSS_COMMENT => ['\*' => CSS_COMM_STAR],
        CSS_COMM_STAR => ['\/' => CSS_COMM_END,   '.' => CSS_COMMENT],
        CSS_OPEN_BRACE => ['\s' => CSS_BLOCK,      '\w' => CSS_PROPERTY, '@' => CSS_MIXIN, '\}' => CSS_CLOSE_BRACE],
        CSS_MIXIN => [';' => CSS_BLOCK],
        CSS_CLOSE_BRACE => ['\w' => CSS_IDENTIFIER, '\/' => CSS_COMMENT,  '#' => CSS_ID, '\.' => CSS_CLASS, '\s' => CSS_WHITESPACE],
        CSS_BLOCK => ['\w' => CSS_PROPERTY,   '@' => CSS_MIXIN, '\{' => CSS_ERROR,    '\}' => CSS_CLOSE_BRACE, '\/' => CSS_BLOCK_COMM],
        CSS_ERROR => ['\s' => CSS_WHITESPACE, '\/' => CSS_COMMENT],
        CSS_OPERATOR => ['\s' => CSS_WHITESPACE, '\w' => CSS_IDENTIFIER, '\.' => CSS_CLASS, '#' => CSS_ID, '\{' => CSS_OPEN_BRACE],
        CSS_BLOCK_COMM => ['\*' => CSS_BLCK_COM_STAR],
        CSS_BLCK_COM_STAR => ['\/' => CSS_B_COMM_END, '.' => CSS_BLOCK_COMM],
        CSS_COMM_END => [CSS_WHITESPACE],
        CSS_B_COMM_END => [CSS_BLOCK],
    ];
